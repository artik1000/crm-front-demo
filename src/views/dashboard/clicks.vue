...
async function updateClicks() {
  response.value = await useAxiosGet(
    `dashboard/clicks/?from=${request.from}&to=${request.to}&page=${request.page}&page_size=${request.page_size}&campaign_exist=${request.campaign_exist}&sub_id_exist=${request.sub_id_exist}${filtersParams}`
  )
