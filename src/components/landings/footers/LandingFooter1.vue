    ...
    <div class="content">
      <div class="text-and-form">
        ...
        <div>
          ...
          <p class="text">
            Sign up for our newsletter and don't miss the new games!
          </p>
          <form class="form">
            <input class="common-input" type="email" name="email" placeholder="Email"/>
            <button aria-label="Subscribe" class="common-button">
              Subscribe
            </button>
          </form>
        </div>
